            ...
            <div className="contact__container container grid">
                ...
                <div className="contact__info">
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data">revanaylano11@upi.edu</span>
                    </div>
                    ...
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data">+62 8997-1440-82</span>
                    </div>
                    ...
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data">@hllwrvy</span>
                    </div>
                </div>
                </div>
